const KycGapReportLocators = {
  ...
  kycGapReportLink: "a.sidebar-link[href='/kyc/kyc-gap-report']",
  ...
  gapReportTableRow: "table tbody tr",
  ...
  gapReportDetailModal: "[role='dialog'].gap-detail-modal, .gap-detail-modal",
