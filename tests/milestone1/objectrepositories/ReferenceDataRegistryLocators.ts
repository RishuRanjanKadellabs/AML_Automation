const ReferenceDataRegistryLocators = {
  ...
  csvExportButton:
    'button:has-text("CSV"), button[title*="CSV" i], button:has-text("⬇ CSV"), button[data-heal-rdr-export="csv"]',
  excelExportButton:
    'button:has-text("Excel"), button[title*="Excel" i], button:has-text("⬇ Excel"), button[data-heal-rdr-export="excel"]',
